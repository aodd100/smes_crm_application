...
<%@ Control Language="c#" AutoEventWireup="true" Codebehind="mailout.ascx.cs" Inherits="IRSLCRM.MailingList.webmail.mailout" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
