...
function delor(component,o){ insertcount = inserthash.containsKey(o)?inserthash.get(o):0; var qc = document.getElementById(o + 'qc'); var delnode = document.getElementById(o + (--insertcount) + 'container'); if(delnode!=null)
qc.removeChild(delnode); inserthash.put(o, insertcount); }
function newor(component,o,myvalue){ 
...
{ if(o.substr(0,1) == "S")
{ sHTML = '<select old=true class="BoxDesign" name="' + o + insertcount + '" id="' + o + insertcount + '">'; var oSrc = document.getElementById(component+"_"+o); for(var i = 0; i < oSrc.options.length; i++)
...
qc.innerHTML+=sHTML; 
document.getElementById(component+"_"+o).style.display='none'; param[param.length]=o; insertcount++; }
else
{ if(o.substr(0,1) == "R")
...
document.getElementById(o.substr(1,o.length-1) + insertcount).value = document.getElementById(component+"_"+o.substr(1,o.length-1)).value; 
document.getElementById(component+"_"+o.substr(1,o.length-1)).style.display='none'; 
...
qc.insertAdjacentHTML('BeforeEnd',sHTML); else
qc.innerHTML+=sHTML; (document.getElementById(o + insertcount)).value = (document.getElementById(component+"_"+o)).value; 
document.getElementById(component+"_"+o).style.display='none'; param[param.length]=o; insertcount++; }
}
}
switch(o.substr(0,1))
{ case "S":
sHTML = '<span id="' + o + insertcount + 'container"><br>or<br><select old=true class="BoxDesign" name="' + o + insertcount + '" id="' + o + insertcount + '">'; var oSrc = document.getElementById(component+"_"+o); for(var i = 0; i < oSrc.options.length; i++){ sel=""; if(myvalue!=null && oSrc.options[i].value==myvalue) sel=" selected"; sHTML += "<option value=" + oSrc.options[i].value + sel + ">" + oSrc.options[i].text + "</option>"; }
