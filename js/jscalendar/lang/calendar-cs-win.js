...
Calendar._DN  = new Array('Nedle','Pondl','ter','Steda','tvrtek','Ptek','Sobota','Nedle'); Calendar._SDN = new Array('Ne','Po','t','St','t','P','So','Ne'); Calendar._MN  = new Array('Leden','nor','Bezen','Duben','Kvten','erven','ervenec','Srpen','Z','jen','Listopad','Prosinec'); Calendar._SMN = new Array('Led','no','Be','Dub','Kv','rv','vc','Srp','Z','j','Lis','Pro'); 
Calendar._TT = {}; Calendar._TT["INFO"] = "O komponent kalend"; Calendar._TT["TOGGLE"] = "Zmna prvnho dne v tdnu"; Calendar._TT["PREV_YEAR"] = "Pedchoz rok (pidr pro menu)"; Calendar._TT["PREV_MONTH"] = "Pedchoz msc (pidr pro menu)"; Calendar._TT["GO_TODAY"] = "Dnen datum"; Calendar._TT["NEXT_MONTH"] = "Dal msc (pidr pro menu)"; Calendar._TT["NEXT_YEAR"] = "Dal rok (pidr pro menu)"; Calendar._TT["SEL_DATE"] = "Vyber datum"; Calendar._TT["DRAG_TO_MOVE"] = "Chy a thni, pro pesun"; Calendar._TT["PART_TODAY"] = " (dnes)"; Calendar._TT["MON_FIRST"] = "Uka jako prvn Pondl"; 
Calendar._TT["ABOUT"] =
...
Calendar._TT["CLOSE"] = "Zavt"; Calendar._TT["TODAY"] = "Dnes"; Calendar._TT["TIME_PART"] = "(Shift-)Klikni nebo thni pro zmnu hodnoty"; 
Calendar._TT["DEF_DATE_FORMAT"] = "d.m.yy"; Calendar._TT["TT_DATE_FORMAT"] = "%a, %b %e"; 
Calendar._TT["WK"] = "wk"; Calendar._TT["TIME"] = "as:"; 