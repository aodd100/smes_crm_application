<%@ Page language="c#" Codebehind="PopPhone.aspx.cs" AutoEventWireup="false" Inherits="IRSLCRM.Common.PopPhone" %>
...
<script type="text/javascript">
    $(function() {
        ...
        function save() {
            dynaret('" + ret + "').value = getElement('CountryCode').value +
                ' ' +
                getElement('Prefix').value +
                ' ' +
                getElement('number').value;
            self.close();
