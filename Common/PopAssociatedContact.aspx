<%@ Page Language="c#" Trace="false" codebehind="PopAssociatedContact.aspx.cs" Inherits="IRSLCRM.PopAssociatedContact"  AutoEventWireup="false"%>
...
<script type="text/javascript">
    ...
    $(function() {
        $("table.normal td label.linked").on('click',function() {
                ...
                //window.parent.document.getElementById(control2).value=txt; 
