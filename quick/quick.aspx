<%@ Page Language="c#" Codebehind="quick.aspx.cs" AutoEventWireup="false" Inherits="IRSLCRM.quick" %>
...
debugger;
	...
	var iframeContacts = document.getElementById("contacts2");
...
{
	var iframeactivity = document.getElementById("activity2");
	var oppID = document.getElementById("TextboxOpportunityID");
...
{
		var IFrameObj;
		if (IE4plus) IFrameObj = window.document.frames['contacts2'];
		 else IFrameObj = window.document.getElementById('contacts2');
...
function SetParams(p,v)
	{
		var IFrameObj;
		if (IE4plus) IFrameObj = window.document.frames['activity2'].document;
		 else IFrameObj = window.document.getElementById('activity2').contentDocument;
            ...
            <tr>
                                ...
                                <table width="100%" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td class="sideContainer">
                                            ...
                                            <iframe id="Info12" name="Info12" runat="server" allowtransparency="true" width="100%"
                                    ...
                                    <tr>
                                        <td class="sideContainer">
                                            ...
                                            <iframe id="Info22" name="Info22" runat="server" allowtransparency="true" width="100%"
                ...
                <td valign="top" class="pageStyle">
                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                            ...
                            <td valign="top" colspan="5" class="sideContainer">
                                <table border="0" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        <td width="19">
                                            <img src="/images/reload.gif" onclick="document.getElementById('contacts2').src=document.getElementById('contacts2').src"></td>
                                    </tr>
                                </table>
                                <iframe id="contacts2" name="contacts2" runat="server" allowtransparency="true" width="100%"
                        ...
                        <tr>
                            <td valign="top" colspan="5" class="sideContainer">
                                <iframe id="activity2" name="activity2" runat="server" allowtransparency="true" width="100%"
