...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ActivityForm.ascx.cs" Inherits="IRSLCRM.WorkingCRM.ActivityForm" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<script>
	var formID = "<%=this.ID%>";
</script>
