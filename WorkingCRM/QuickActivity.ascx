...
<%@ Control Language="c#" AutoEventWireup="true" Codebehind="QuickActivity.ascx.cs" Inherits="IRSLCRM.WorkingCRM.QuickActivity" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
